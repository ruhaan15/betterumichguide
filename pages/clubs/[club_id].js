        ...
        <>
            <div className="flex mb-6">
                <Image
                    ...
                    className="rounded"
                />
                <h1 className="text-[22px] font-medium pl-7 py-2 ">
                    {club.name}
                </h1>
                    ...
                    <div className="mt-6 ">
                        ...
                        >
                            ...
                            <button className="align-middle mx-2 bg-white-500 hover:bg-gray-200 text-white font-bold py-2 px-4 rounded btn btn-white">
                                <Image
                                    src="http://www.clker.com/cliparts/8/3/1/b/13652250221684996142Email%20Icon.svg.med.png"
                                    alt="Email"
                                    width={40}
                                    height={40}
                                />
                        ...
                        >
                            <button className="align-middle mx-2 bg-white-500 hover:bg-gray-200 text-white font-bold py-2 px-4 rounded btn btn-white">
                                ...
                                <Image
                                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Instagram_logo_2016.svg/124px-Instagram_logo_2016.svg.png"
                                    alt="Club Logo"
                                    width={30}
                                    height={30}
                                    className="rounded"
                        ...
                        <a
                            ...
                            rel="noreferrer"
                        >
                            <button className="align-middle mx-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 h-8">
                                Website{" "}
                            </button>
                        </a>
                    </div>
